...
print()
print(
    f"  UFR corner: U[8]={result['U'][8]}, F[2]={result['F'][2]}, R[0]={result['R'][0]}"
)
print(
    f"  UFL corner: U[6]={result['U'][6]}, F[0]={result['F'][0]}, L[2]={result['L'][2]}"
)
print(
    f"  UBR corner: U[2]={result['U'][2]}, B[0]={result['B'][0]}, R[2]={result['R'][2]}"
)
...
print(
    f"  UF: U[7]={result2['U'][7]}, F[1]={result2['F'][1]} (should be UR's colors: Y,R)"
)
print(
    f"  UR: U[5]={result2['U'][5]}, R[1]={result2['R'][1]} (should be UF's colors: Y,G)"
)
